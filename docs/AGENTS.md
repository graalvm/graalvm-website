...
- Add cross-links with standard Markdown link syntax, for example `[Native Image Overview](https://raw.githubusercontent.com/oracle/graal/master/reference-manual/native-image/Overview.md)`, and prefer descriptive link text over raw URLs.
