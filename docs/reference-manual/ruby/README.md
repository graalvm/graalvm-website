...
* Via [GraalVM](installing-graalvm.md), which includes support for
  ...
  We recommend that you use a [Ruby manager](ruby-managers.md#configuring-ruby-managers-for-the-full-graalvm-distribution)
  to use TruffleRuby inside GraalVM.

* Via your [Ruby manager/installer](ruby-managers.md) (RVM, rbenv,
...
* Via the [standalone distribution](standalone-distribution.md)
...
See the [Ruby installers](ruby-managers.md) documentation for more details.
...
See [Testing TruffleRuby in CI](standalone-distribution.md) for more details and other CIs.
...
* Add fast and low-overhead interoperability with languages like Java, JavaScript, Python, and R.
  * Provided by GraalVM, see the [Polyglot documentation](polyglot.md).
* Provide new tooling, such as debuggers and monitoring, that works across languages.
  * Includes a profiler, debugger, VisualVM, and more. See the [Tools documentation](tools.md).
...
Runtime configurations are further detailed in [Deploying TruffleRuby](deploying.md).
...
* [make and gcc](installing-llvm.md) for building C and C++ extensions
* [libssl](installing-libssl.md) for the `openssl` C extension
* [zlib](installing-zlib.md) for the `zlib` C extension
...
You may also need to set up a [UTF-8 locale](utf8-locale.md).

See the [contributor workflow](https://github.com/oracle/truffleruby/blob/master/doc/contributor/workflow.md) document if you wish to build TruffleRuby from source.
...
should read about our [compatibility](compatibility.md).
...
should read our [migration guide](jruby-migration.md).
...
See [SECURITY](https://github.com/oracle/truffleruby/blob/master/SECURITY.md) for how to report security vulnerabilities to Oracle.
For known vulnerabilities in Ruby, please refer to the [known-cves](known-cves.md) file.
...
For further licensing information, see [LICENCE](https://github.com/oracle/truffleruby/blob/master/LICENCE.md), [3rd_party_licenses](https://github.com/oracle/truffleruby/blob/master/3rd_party_licenses.txt), and [doc/legal/legal](https://github.com/oracle/truffleruby/blob/master/doc/legal/legal.md).
